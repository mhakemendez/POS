                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav m-auto">
                        <li class="nav-item mt-1">
                            <a class="nav-link btn btn-warning menus" href=" {{ route('admin.home') }} "><i
                                    class="fas fa-home icons"></i>{{ __('Home') }}</a>
                        </li>
                        <li class="nav-item mt-1">
                            <a class="nav-link btn btn-warning menus" href="{{ route('users.index') }}"><i
                                    class="fas fa-user icons"></i>{{ __('User') }}</a>
                        </li>
                        <li class="nav-item mt-1">
                            <a class="nav-link btn btn-warning menus" href=" {{ route('product.index') }} "><i
                                    class="fas fa-hamburger icons"></i>{{ __('Products') }}</a>
                        </li>
                        <li class="nav-item mt-1">
                            <a class="nav-link btn btn-warning menus" href="{{ route('category.index') }}"><i
                                    class="fas fa-square icons"></i>{{ __('Category') }}</a>
                        </li>
                        <li class="nav-item mt-1">
                        ...
                        <li class="nav-item mt-1">
                            <a class="nav-link btn btn-warning menus" href="{{ route('invoice.index') }}"><i
                                    class="fas fa-money-bill-alt icons"></i>{{ __('Sales') }}</a>
                        </li>
                    </ul>
